    ...
    */
    ...
    public R save(@RequestBody ChongwuEntity chongwu, HttpServletRequest request){
        ...
        Wrapper<ChongwuEntity> queryWrapper = new EntityWrapper<ChongwuEntity>()
            ...
            .eq("chongwu_erji_types", chongwu.getChongwuErjiTypes())
            .eq("chongwu_leixing_types", chongwu.getChongwuLeixingTypes())
            .eq("chongwu_dian_name", chongwu.getChongwuDianName())
            .eq("chongwu_address", chongwu.getChongwuAddress())
            .eq("chongwu_clicknum", chongwu.getChongwuClicknum())
            .eq("shangxia_types", chongwu.getShangxiaTypes())
...
//                            chongwuEntity.setChongwuAge(data.get(0));                    //年龄 要改的
//                            chongwuEntity.setChongwuTypes(Integer.valueOf(data.get(0)));   //省 要改的
//                            chongwuEntity.setChongwuErjiTypes(Integer.valueOf(data.get(0)));   //市 要改的
//                            chongwuEntity.setChongwuLeixingTypes(Integer.valueOf(data.get(0)));   //宠物类型 要改的
//                            chongwuEntity.setChongwuNewMoney(data.get(0));                    //价格 要改的
//                            chongwuEntity.setChongwuDianName(data.get(0));                    //线下店名 要改的
//                            chongwuEntity.setChongwuAddress(data.get(0));                    //线下位置 要改的
//                            chongwuEntity.setChongwuClicknum(Integer.valueOf(data.get(0)));   //点击次数 要改的
//                            chongwuEntity.setChongwuContent("");//照片
//                            chongwuEntity.setShangxiaTypes(Integer.valueOf(data.get(0)));   //是否上架 要改的
